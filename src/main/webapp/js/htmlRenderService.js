class HtmlRenderService {
    ...
    renderEditRaw(editButtonId, id) {
        ...
        tdRace.innerHTML = this.getDropdownHtml(id, 'race', ['HUMAN', 'DWARF', 'ELF', 'GIANT', 'ORC', 'TROLL', 'HOBBIT'])
        ...
        tdProfession.innerHTML = this.getDropdownHtml(id, 'profession', ['WARRIOR', 'ROGUE', 'SORCERER', 'CLERIC', 'PALADIN', 'NAZGUL', 'WARLOCK', 'DRUID'])
        ...
        tdBanned.innerHTML = this.getDropdownHtml(id, 'banned', [false, true])
    ...
    getDropdownHtml(id, name, values) {
